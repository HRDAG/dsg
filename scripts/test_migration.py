...
def check_dsg_directories(repo: str, snapshots: List[str]) -> TestResult:
    """
...
def check_last_sync_files(repo: str, snapshots: List[str]) -> TestResult:
    """
...
def check_sync_messages(repo: str, snapshots: List[str]) -> TestResult:
    """
...
def check_archive_files(repo: str, snapshots: List[str]) -> TestResult:
    """
...
def check_manifest_integrity(repo: str, snapshots: List[str]) -> TestResult:
    """
...
def check_snapshot_chain(repo: str, snapshots: List[str]) -> TestResult:
    """
...
def check_push_log_consistency(repo: str, snapshots: List[str]) -> TestResult:
    """
...
def check_unique_files(repo: str, snapshots: List[str]) -> TestResult:
    """
